...
public class StubData {
  private String randomUUID(){
    return ("http://testing.uri#Resource_" + UUID.randomUUID()).replaceAll("-", "_");
  }
  public AOMRepository repositoryStub(){
    
    AOMRepository repo = mock(AOMRepository.class);
    doReturn(new ValueFactoryImpl()).when(repo).getValueFactory();

    when(repo.getURI(any(String.class))).thenReturn(randomUUID())
    ...
    .thenReturn(randomUUID())
    .thenReturn(randomUUID());
    when(repo.getURI(any(OntologyClass.class))).thenReturn(randomUUID())
    .thenReturn(randomUUID())
    .thenReturn(randomUUID())
    .thenReturn(randomUUID())
    .thenReturn(randomUUID())
