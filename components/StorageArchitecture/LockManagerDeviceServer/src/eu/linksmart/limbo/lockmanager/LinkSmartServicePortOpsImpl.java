...
public class LinkSmartServicePortOpsImpl {
	...
	public LinkSmartServicePortOpsImpl(){
		...
		//((WSEndpointStateVariable)this.getwsendpoint.getStateVariable("wsendpoint")).set(LockManagerDeviceServlet.getEndpoint());
		...
		InputStream is = LinkSmartServicePortOpsImpl.class.getResourceAsStream("/resources/LockManagerDevice.wsdl");
