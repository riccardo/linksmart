...
public class requestStateVariable implements UPnPLocalStateVariable{
	final private String NAME = "request";
	final private String DEFAULT_VALUE = "";
	private UPnPEventNotifier notifier;
	private String request = DEFAULT_VALUE;
