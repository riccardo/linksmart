...
public class LinkSmartServicePortOpsImpl {
	...
	public LinkSmartServicePortOpsImpl(){
		...
		//((WSEndpointStateVariable)this.getwsendpoint.getStateVariable("wsendpoint")).set(StorageManagerDeviceServlet.getEndpoint());
		...
		InputStream is = LinkSmartServicePortOpsImpl.class.getResourceAsStream("/resources/StorageManagerDevice.wsdl");
