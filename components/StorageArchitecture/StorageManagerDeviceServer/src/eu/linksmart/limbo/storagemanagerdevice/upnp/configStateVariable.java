...
public class configStateVariable implements UPnPLocalStateVariable{
	final private String NAME = "config";
	final private String DEFAULT_VALUE = "";
	private UPnPEventNotifier notifier;
	private String config = DEFAULT_VALUE;
