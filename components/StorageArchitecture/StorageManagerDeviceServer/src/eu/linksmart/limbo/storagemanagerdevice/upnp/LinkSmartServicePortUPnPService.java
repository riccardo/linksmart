...
public class LinkSmartServicePortUPnPService implements UPnPService {
	...
	public LinkSmartServicePortUPnPService(StorageManagerDeviceDevice device) {
		this.device = device;
		...
		InputStream is = LinkSmartServicePortUPnPService.class.getResourceAsStream("/resources/StorageManagerDevice.wsdl");
	...
	public String CreateWS(){
		this.WSEndpoint.set(StorageManagerServlet.getEndpoint());
