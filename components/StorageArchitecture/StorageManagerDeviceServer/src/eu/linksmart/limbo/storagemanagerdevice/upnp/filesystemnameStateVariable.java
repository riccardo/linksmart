...
public class filesystemnameStateVariable implements UPnPLocalStateVariable{
	final private String NAME = "filesystemname";
	final private String DEFAULT_VALUE = "";
	private UPnPEventNotifier notifier;
	private String filesystemname = DEFAULT_VALUE;
	...
	public void set(String value) {
		if (!value.equals(filesystemname)) {
			String oldValue = filesystemname;
