...
public class StorageManagerDeviceUPnPActivator implements BundleActivator {
	...
	private void doServiceRegistration() {
		...
		this.device = new StorageManagerDeviceDevice(context);
	...
	public void start(BundleContext context) throws Exception {
		StorageManagerDeviceUPnPActivator.context = context;
