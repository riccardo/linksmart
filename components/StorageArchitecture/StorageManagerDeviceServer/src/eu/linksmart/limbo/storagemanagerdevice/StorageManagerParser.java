...
public class StorageManagerParser {
	...
	public StorageManagerParser(String total, String soapaction){
		this.request = total;
	...
	public Vector createStorageDevice(String subRequest){
		...
		nArgs = 1;
		V = new Vector(nArgs);
		before ="createStorageDevice";
		after = "createStorageDevice>";
		if((subRequest.indexOf(before)!=-1) && (subRequest.endsWith(after))) {
		if((subRequest.indexOf("<config",0)!=-1)) {
	...
	public Vector createStorageDeviceLocal(String subRequest){
		...
		nArgs = 1;
		V = new Vector(nArgs);
		before ="createStorageDeviceLocal";
		after = "createStorageDeviceLocal>";
		if((subRequest.indexOf(before)!=-1) && (subRequest.endsWith(after))) {
		if((subRequest.indexOf("<config",0)!=-1)) {
			st = new StringTokenizer(subRequest,">");
			before = st.nextToken();
	...
	public Vector deleteStorageDevice(String subRequest){
		...
		nArgs = 1;
		V = new Vector(nArgs);
		before ="deleteStorageDevice";
		after = "deleteStorageDevice>";
		if((subRequest.indexOf(before)!=-1) && (subRequest.endsWith(after))) {
		if((subRequest.indexOf("<id",0)!=-1)) {
			st = new StringTokenizer(subRequest,">");
			before = st.nextToken();
			before = before.concat(">");
			result = subRequest.substring(before.length(), subRequest.lastIndexOf('<'));
	...
	public Vector deleteStorageDeviceLocal(String subRequest){
		...
		nArgs = 1;
		V = new Vector(nArgs);
		before ="deleteStorageDeviceLocal";
		after = "deleteStorageDeviceLocal>";
		if((subRequest.indexOf(before)!=-1) && (subRequest.endsWith(after))) {
		if((subRequest.indexOf("<id",0)!=-1)) {
			st = new StringTokenizer(subRequest,">");
			before = st.nextToken();
	...
	public Vector getSupportedStorageDevices(String subRequest){
		...
		nArgs = 0;
		V = new Vector(nArgs);
		before ="getSupportedStorageDevices";
		after = "getSupportedStorageDevices>";

		if((subRequest.indexOf("getSupportedStorageDevices")!=-1) && (subRequest.endsWith("/>"))) {
			result = "";
			this.nrArgs= nArgs;
			return V;
		}
	...
	public Vector getStorageDevices(String subRequest){
		...
		nArgs = 0;
		V = new Vector(nArgs);
		before ="getStorageDevices";
		after = "getStorageDevices>";

		if((subRequest.indexOf("getStorageDevices")!=-1) && (subRequest.endsWith("/>"))) {
			result = "";
			this.nrArgs= nArgs;
			return V;
		}
	...
	public Vector getStorageDeviceConfig(String subRequest){
		...
		nArgs = 1;
		V = new Vector(nArgs);
		before ="getStorageDeviceConfig";
		after = "getStorageDeviceConfig>";
		if((subRequest.indexOf(before)!=-1) && (subRequest.endsWith(after))) {
		if((subRequest.indexOf("<id",0)!=-1)) {
			st = new StringTokenizer(subRequest,">");
			before = st.nextToken();
	...
	public Vector updateStorageDevice(String subRequest){
		...
		nArgs = 1;
		V = new Vector(nArgs);
		before ="updateStorageDevice";
		after = "updateStorageDevice>";
		if((subRequest.indexOf(before)!=-1) && (subRequest.endsWith(after))) {
		if((subRequest.indexOf("<config",0)!=-1)) {
			st = new StringTokenizer(subRequest,">");
			before = st.nextToken();
	...
	public Vector updateStorageDeviceLocal(String subRequest){
		...
		nArgs = 1;
		V = new Vector(nArgs);
		before ="updateStorageDeviceLocal";
		after = "updateStorageDeviceLocal>";
		if((subRequest.indexOf(before)!=-1) && (subRequest.endsWith(after))) {
		if((subRequest.indexOf("<config",0)!=-1)) {
			st = new StringTokenizer(subRequest,">");
			before = st.nextToken();
