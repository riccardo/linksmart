...
public class IntegerResponse extends Response {
	...
	public final static String ROOT_TYPE = "integerResponse"; 
	private Integer result;

    public IntegerResponse(int errorCode, String errorMessage, Integer result) {
    	super(ROOT_TYPE, errorCode, errorMessage);
    	this.result = result;
    }
    
    public IntegerResponse(String xmlData) throws JDOMException, IOException {
