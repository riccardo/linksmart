...
public class VoidResponse extends Response {
	...
	public static final String ROOT_TYPE = "voidResult";
	
	public VoidResponse(int errorCode, String errorMessage) {
		super(ROOT_TYPE, errorCode, errorMessage);
	}
	
	public VoidResponse(String xmlData) throws JDOMException, IOException {
