...
public class StringResponse extends Response {
	...
	public static final String ROOT_TYPE = "stringResponse"; 
	private String result;

    public StringResponse(int errorCode, String errorMessage, String result) {
    	super(ROOT_TYPE, errorCode, errorMessage);
    	this.result = result;
    }
    
    public StringResponse(String xmlData) throws JDOMException, IOException {
	...
	protected void writeResult(Element e) {
		if (result != null)
			e.addContent(new Element("value").addContent(result));
	}
}
