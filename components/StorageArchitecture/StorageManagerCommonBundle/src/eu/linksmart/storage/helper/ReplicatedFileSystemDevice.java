...
public class ReplicatedFileSystemDevice {
	...
	public ReplicatedFileSystemDevice(String name, String id, String systemId,
	...
	public ReplicatedFileSystemDevice(String name, String id, String systemId) {
		this(name, id, systemId, new Vector<String>());
	}
	
	public ReplicatedFileSystemDevice(String name, Vector<String> backendDevices) {
		this(name, null, null, backendDevices);
	}
	
	@SuppressWarnings("unchecked")
	public ReplicatedFileSystemDevice(String xmlData) throws IOException {
		try {
	...
	@SuppressWarnings("unchecked")
	public ReplicatedFileSystemDevice(Element e) {
		name = e.getAttributeValue("Name");
		id = e.getAttributeValue("ID");
		systemId = e.getAttributeValue("SystemID");
		backendDevices = new Vector<String>();
	...
	public Element toXML() {
		Element root = new Element("ReplicatedFileSystemDevice");
