...
public class BooleanResponse extends Response {
	...
	public static final String ROOT_TYPE = "booleanResponse"; 
	private Boolean result;

    public BooleanResponse(int errorCode, String errorMessage, Boolean result) {
    	super(ROOT_TYPE, errorCode, errorMessage);
    	this.result = result;
    }
    
    public BooleanResponse(String xmlData) throws JDOMException, IOException {
