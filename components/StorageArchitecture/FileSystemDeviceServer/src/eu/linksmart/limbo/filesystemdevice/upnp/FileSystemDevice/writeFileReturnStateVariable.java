...
public class writeFileReturnStateVariable implements UPnPLocalStateVariable{
	final private String NAME = "writeFileReturn";
	final private String DEFAULT_VALUE = "";
	private UPnPEventNotifier notifier;
	private String writeFileReturn = DEFAULT_VALUE;
	...
	public void set(String value) {
		if (!value.equals(writeFileReturn)) {
			String oldValue = writeFileReturn;
			writeFileReturn = value;
			if (notifier != null)
