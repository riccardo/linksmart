...
public class createDirectoryReturnStateVariable implements UPnPLocalStateVariable{
	final private String NAME = "createDirectoryReturn";
	final private String DEFAULT_VALUE = "";
	private UPnPEventNotifier notifier;
	private String createDirectoryReturn = DEFAULT_VALUE;

	
	public Object getCurrentValue() {
		return createDirectoryReturn;
	}
	...
	public void set(String value) {
		if (!value.equals(createDirectoryReturn)) {
			String oldValue = createDirectoryReturn;
			createDirectoryReturn = value;
			if (notifier != null)
