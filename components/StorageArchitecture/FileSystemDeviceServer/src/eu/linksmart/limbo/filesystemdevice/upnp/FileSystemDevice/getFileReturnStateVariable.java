...
public class getFileReturnStateVariable implements UPnPLocalStateVariable{
	final private String NAME = "getFileReturn";
	final private String DEFAULT_VALUE = "";
	private UPnPEventNotifier notifier;
	private String getFileReturn = DEFAULT_VALUE;

	
	public Object getCurrentValue() {
		return getFileReturn;
	}
	...
	public void set(String value) {
		if (!value.equals(getFileReturn)) {
			String oldValue = getFileReturn;
			getFileReturn = value;
			if (notifier != null)
