...
public class ErrorMessageStateVariable implements UPnPLocalStateVariable{
	final private String NAME = "ErrorMessage";
	final private String DEFAULT_VALUE = "";
	private UPnPEventNotifier notifier;
	private String ErrorMessage = DEFAULT_VALUE;
