...
public class copyReturnStateVariable implements UPnPLocalStateVariable{
	final private String NAME = "copyReturn";
	final private String DEFAULT_VALUE = "";
	private UPnPEventNotifier notifier;
	private String copyReturn = DEFAULT_VALUE;
	...
	public void set(String value) {
		if (!value.equals(copyReturn)) {
			String oldValue = copyReturn;
			copyReturn = value;
			if (notifier != null)
