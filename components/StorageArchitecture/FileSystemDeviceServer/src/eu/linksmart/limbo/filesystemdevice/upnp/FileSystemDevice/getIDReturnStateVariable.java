...
public class getIDReturnStateVariable implements UPnPLocalStateVariable{
	final private String NAME = "getIDReturn";
	final private String DEFAULT_VALUE = "";
	private UPnPEventNotifier notifier;
	private String getIDReturn = DEFAULT_VALUE;
	...
	public void set(String value) {
		if (!value.equals(getIDReturn)) {
			String oldValue = getIDReturn;
			getIDReturn = value;
			if (notifier != null)
