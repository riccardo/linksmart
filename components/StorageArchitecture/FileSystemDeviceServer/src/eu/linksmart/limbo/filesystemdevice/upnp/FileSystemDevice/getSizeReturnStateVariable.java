...
public class getSizeReturnStateVariable implements UPnPLocalStateVariable{
	final private String NAME = "getSizeReturn";
	final private String DEFAULT_VALUE = "";
	private UPnPEventNotifier notifier;
	private String getSizeReturn = DEFAULT_VALUE;
	...
	public void set(String value) {
		if (!value.equals(getSizeReturn)) {
			String oldValue = getSizeReturn;
			getSizeReturn = value;
			if (notifier != null)
