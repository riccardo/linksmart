...
public class destinationStateVariable implements UPnPLocalStateVariable{
	final private String NAME = "destination";
	final private String DEFAULT_VALUE = "";
	private UPnPEventNotifier notifier;
	private String destination = DEFAULT_VALUE;
