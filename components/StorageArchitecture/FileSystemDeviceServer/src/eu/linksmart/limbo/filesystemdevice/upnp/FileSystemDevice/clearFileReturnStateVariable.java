...
public class clearFileReturnStateVariable implements UPnPLocalStateVariable{
	final private String NAME = "clearFileReturn";
	final private String DEFAULT_VALUE = "";
	private UPnPEventNotifier notifier;
	private String clearFileReturn = DEFAULT_VALUE;

	
	public Object getCurrentValue() {
		return clearFileReturn;
	}
	...
	public void set(String value) {
		if (!value.equals(clearFileReturn)) {
			String oldValue = clearFileReturn;
			clearFileReturn = value;
			if (notifier != null)
			notifier.propertyChange(new PropertyChangeEvent(this,NAME,oldValue,value));
		}
	}
	public String get() {
		return this.clearFileReturn;
