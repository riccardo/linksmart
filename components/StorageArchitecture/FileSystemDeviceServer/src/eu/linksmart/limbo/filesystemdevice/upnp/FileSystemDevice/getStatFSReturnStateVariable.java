...
public class getStatFSReturnStateVariable implements UPnPLocalStateVariable{
	final private String NAME = "getStatFSReturn";
	final private String DEFAULT_VALUE = "";
	private UPnPEventNotifier notifier;
	private String getStatFSReturn = DEFAULT_VALUE;

	
	public Object getCurrentValue() {
		return getStatFSReturn;
	}
	...
	public void set(String value) {
		if (!value.equals(getStatFSReturn)) {
			String oldValue = getStatFSReturn;
			getStatFSReturn = value;
			if (notifier != null)
			notifier.propertyChange(new PropertyChangeEvent(this,NAME,oldValue,value));
		}
	}
	public String get() {
		return this.getStatFSReturn;
