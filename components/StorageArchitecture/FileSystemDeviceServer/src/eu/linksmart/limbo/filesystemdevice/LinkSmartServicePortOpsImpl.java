...
public class LinkSmartServicePortOpsImpl {
	...
	public LinkSmartServicePortOpsImpl(FileSystemDeviceDevice device){
		this.device = device;
		...
		//((WSEndpointStateVariable)this.getwsendpoint.getStateVariable("wsendpoint")).set(FileSystemDeviceServlet.getEndpoint());
		...
		InputStream is = LinkSmartServicePortOpsImpl.class.getResourceAsStream("/resources/FileSystemDevice.wsdl");
