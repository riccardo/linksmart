...
public class readFileReturnStateVariable implements UPnPLocalStateVariable{
	final private String NAME = "readFileReturn";
	final private String DEFAULT_VALUE = "";
	private UPnPEventNotifier notifier;
	private String readFileReturn = DEFAULT_VALUE;
	...
	public void set(String value) {
		if (!value.equals(readFileReturn)) {
			String oldValue = readFileReturn;
			readFileReturn = value;
			if (notifier != null)
