...
public class wsdlStateVariable implements UPnPLocalStateVariable{
	final private String NAME = "wsdl";
	final private String DEFAULT_VALUE = "";
	private UPnPEventNotifier notifier;
	private String wsdl = DEFAULT_VALUE;
	...
	public void set(String value) {
		if (!value.equals(wsdl)) {
			String oldValue = wsdl;
			wsdl = value;
			if (notifier != null)
