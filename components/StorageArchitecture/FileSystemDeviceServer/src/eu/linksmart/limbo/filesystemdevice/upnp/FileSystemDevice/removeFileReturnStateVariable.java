...
public class removeFileReturnStateVariable implements UPnPLocalStateVariable{
	final private String NAME = "removeFileReturn";
	final private String DEFAULT_VALUE = "";
	private UPnPEventNotifier notifier;
	private String removeFileReturn = DEFAULT_VALUE;

	
	public Object getCurrentValue() {
		return removeFileReturn;
	}
	...
	public void set(String value) {
		if (!value.equals(removeFileReturn)) {
			String oldValue = removeFileReturn;
			removeFileReturn = value;
			if (notifier != null)
			notifier.propertyChange(new PropertyChangeEvent(this,NAME,oldValue,value));
		}
	}
	public String get() {
		return this.removeFileReturn;
