...
public class LinkSmartServicePortServlet extends HttpServlet {
	...
	public LinkSmartServicePortServlet(String serverHost, int port, String path, FileSystemDeviceDevice device){
		super();
		try {
		...
		service = new LinkSmartServicePortService(serverHost, port, device);
			...
			try {
        		...
        		requestAsString = requestAsString.concat(request.getMethod()+" / "+request.getProtocol()+"\r\n");
           		...
           		while( headerNames.hasMoreElements()){
            		...
            		responseAsString = service.handleRequest(requestAsString,this.clientHost);
            	}
            	catch(Exception e)
            	{
                	e.printStackTrace();
