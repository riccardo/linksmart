...
public class LinkSmartServicePortUPnPService implements UPnPService {
	...
	public LinkSmartServicePortUPnPService(FileSystemDeviceDevice device) {
		this.device = device;
		...
		InputStream is = LinkSmartServicePortUPnPService.class.getResourceAsStream("/resources/FileSystemDevice.wsdl");
	...
	public String CreateWS(){
		this.WSEndpoint.set(device.deviceActivator.fileSystemDeviceServlet.getEndpoint());
		this.LinkSmartWSEndpoint.set(device.deviceActivator.LinkSmartServicePortservlet.getEndpoint());
