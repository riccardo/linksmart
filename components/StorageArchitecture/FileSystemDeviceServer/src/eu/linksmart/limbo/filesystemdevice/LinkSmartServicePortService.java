...
public class LinkSmartServicePortService extends LinkSmartServicePortEndPoint{
	...
	public LinkSmartServicePortService(String serverHost, int serverPort, FileSystemDeviceDevice device) {
		this.operations = new LinkSmartServicePortOpsImpl(device);
