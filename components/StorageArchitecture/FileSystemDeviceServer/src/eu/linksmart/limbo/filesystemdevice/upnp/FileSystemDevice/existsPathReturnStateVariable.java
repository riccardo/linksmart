...
public class existsPathReturnStateVariable implements UPnPLocalStateVariable{
	final private String NAME = "existsPathReturn";
	final private String DEFAULT_VALUE = "";
	private UPnPEventNotifier notifier;
	private String existsPathReturn = DEFAULT_VALUE;
	...
	public void set(String value) {
		if (!value.equals(existsPathReturn)) {
			String oldValue = existsPathReturn;
			existsPathReturn = value;
			if (notifier != null)
			notifier.propertyChange(new PropertyChangeEvent(this,NAME,oldValue,value));
		}
	}
	public String get() {
		return this.existsPathReturn;
