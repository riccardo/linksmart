...
public class moveReturnStateVariable implements UPnPLocalStateVariable{
	final private String NAME = "moveReturn";
	final private String DEFAULT_VALUE = "";
	private UPnPEventNotifier notifier;
	private String moveReturn = DEFAULT_VALUE;
	...
	public void set(String value) {
		if (!value.equals(moveReturn)) {
			String oldValue = moveReturn;
			moveReturn = value;
			if (notifier != null)
