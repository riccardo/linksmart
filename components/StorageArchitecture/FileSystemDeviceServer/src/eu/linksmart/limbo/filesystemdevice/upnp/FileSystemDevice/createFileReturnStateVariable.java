...
public class createFileReturnStateVariable implements UPnPLocalStateVariable{
	final private String NAME = "createFileReturn";
	final private String DEFAULT_VALUE = "";
	private UPnPEventNotifier notifier;
	private String createFileReturn = DEFAULT_VALUE;
	...
	public void set(String value) {
		if (!value.equals(createFileReturn)) {
			String oldValue = createFileReturn;
			createFileReturn = value;
			if (notifier != null)
			notifier.propertyChange(new PropertyChangeEvent(this,NAME,oldValue,value));
		}
	}
	public String get() {
		return this.createFileReturn;
