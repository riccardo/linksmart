...
public class propertiesNameStateVariable implements UPnPLocalStateVariable{
	final private String NAME = "propertiesName";
	final private String DEFAULT_VALUE = "";
	private UPnPEventNotifier notifier;
	private String propertiesName = DEFAULT_VALUE;
	...
	public void set(String value) {
		if (!value.equals(propertiesName)) {
			String oldValue = propertiesName;
