...
public class recursiveStateVariable implements UPnPLocalStateVariable{
	final private String NAME = "recursive";
	final private Boolean DEFAULT_VALUE = false;
	private UPnPEventNotifier notifier;
	private Boolean recursive = DEFAULT_VALUE;
