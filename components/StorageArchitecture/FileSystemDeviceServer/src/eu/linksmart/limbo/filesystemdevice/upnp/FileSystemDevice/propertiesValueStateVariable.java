...
public class propertiesValueStateVariable implements UPnPLocalStateVariable{
	final private String NAME = "propertiesValue";
	final private String DEFAULT_VALUE = "";
	private UPnPEventNotifier notifier;
	private String propertiesValue = DEFAULT_VALUE;
	...
	public void set(String value) {
		if (!value.equals(propertiesValue)) {
			String oldValue = propertiesValue;
