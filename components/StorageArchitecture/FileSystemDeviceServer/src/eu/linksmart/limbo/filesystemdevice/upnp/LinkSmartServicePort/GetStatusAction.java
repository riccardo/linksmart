...
public class GetStatusAction implements UPnPAction {
	...
	final private String[] OUT_ARG_NAMES = new String[]{STATUS};

	private StatusStateVariable Status;
	private LinkSmartServicePortUPnPService service;

	public GetStatusAction(StatusStateVariable Status, LinkSmartServicePortUPnPService service) {
		this.Status = Status;
	...
	public Dictionary invoke(Dictionary args) throws Exception {
		...
		java.lang.String res = this.service.GetStatus();
