...
public class cookieNameStateVariable implements UPnPLocalStateVariable{
	final private String NAME = "cookieName";
	final private String DEFAULT_VALUE = "";
	private UPnPEventNotifier notifier;
	private String cookieName = DEFAULT_VALUE;
