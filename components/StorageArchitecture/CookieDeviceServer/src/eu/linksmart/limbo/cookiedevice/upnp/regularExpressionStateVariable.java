...
public class regularExpressionStateVariable implements UPnPLocalStateVariable{
	final private String NAME = "regularExpression";
	final private String DEFAULT_VALUE = "";
	private UPnPEventNotifier notifier;
	private String regularExpression = DEFAULT_VALUE;
	...
	public void set(String value) {
		if (!value.equals(regularExpression)) {
			String oldValue = regularExpression;
