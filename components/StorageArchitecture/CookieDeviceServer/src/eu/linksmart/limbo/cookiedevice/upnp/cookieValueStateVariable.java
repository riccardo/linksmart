...
public class cookieValueStateVariable implements UPnPLocalStateVariable{
	final private String NAME = "cookieValue";
	final private String DEFAULT_VALUE = "";
	private UPnPEventNotifier notifier;
	private String cookieValue = DEFAULT_VALUE;
