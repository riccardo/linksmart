...
public class LinkSmartServicePortUPnPService implements UPnPService {
	...
	public LinkSmartServicePortUPnPService(CookieDeviceDevice device) {
		this.device = device;
		...
		InputStream is = LinkSmartServicePortUPnPService.class.getResourceAsStream("/resources/CookieDevice.wsdl");
	...
	public String CreateWS(){
		this.WSEndpoint.set(CookieServlet.getEndpoint());
