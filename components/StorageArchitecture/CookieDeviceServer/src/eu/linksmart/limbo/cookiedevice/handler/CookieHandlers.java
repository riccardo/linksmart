...
public class CookieHandlers implements CookieHandlerService{

	private CookieHandlerService serviceInt;
	...
	public CookieHandlers(CookieService service) {
		this.service = service;
		CookieSOAPHandler soaphandler = new CookieSOAPHandler(this);		
