...
/** 
 * Servlet to configure the LinkSmart Middleware 
 */
public class LinkSmartStatus extends HttpServlet {
	...
	/**
	 * Constructor of the class LinkSmartStatus
	 *  
	 * @param context the bundle's execution context
	 */
	public LinkSmartStatus(ComponentContext context) {
	}
	...
	public void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		InputStream stream = LinkSmartStatus.class.getResourceAsStream(resource);
