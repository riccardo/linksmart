...
public class IdentityMgrPolicyInformationPointTest {
	...
	public void setUp() throws RemoteException {
		...
		this.identityPip = new IdentityMgrPolicyInformationPoint();
		identityPip.idM = identityMgr;

		when(identityMgr.getServiceInfo(VIRTUAL_ADDRESS)).thenReturn(MY_REGISTRATION);
		when(identityMgr.getServiceInfo(VIRTUAL_ADDRESS2)).thenReturn(OTHER_REGISTRATION);
	}
