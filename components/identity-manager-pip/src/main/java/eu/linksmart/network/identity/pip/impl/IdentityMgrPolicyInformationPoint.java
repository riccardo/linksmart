...
/**
 * The XACML Policy Information Point interface for any Identity Manager.
 * This can be queried by the Policy Decision Point for any Registration
 * related attributes.
 * 
 * @author Vinkovits
 *
 */
@Component(name="IdentityManagerPIP", immediate=true)
@Service({PolicyInformationPoint.class})
