...
public class NetworkManagerSoapBindingStub extends org.apache.axis.client.Stub implements eu.linksmart.network.networkmanager.NetworkManager {
    ...
    private static void _initOperationDesc1(){
        ...
        param = new org.apache.axis.description.ParameterDesc(new javax.xml.namespace.QName("", "in0"), org.apache.axis.description.ParameterDesc.IN, new javax.xml.namespace.QName("http://network.linksmart.eu", "HID"), eu.linksmart.network.HID.class, false, false);
        oper.addParameter(param);
        param = new org.apache.axis.description.ParameterDesc(new javax.xml.namespace.QName("", "in1"), org.apache.axis.description.ParameterDesc.IN, new javax.xml.namespace.QName("http://network.linksmart.eu", "HID"), eu.linksmart.network.HID.class, false, false);
        oper.addParameter(param);
        ...
        oper.setReturnType(new javax.xml.namespace.QName("http://networkmanager.network.linksmart.eu", "ArrayOf_xsd_string"));
        oper.setReturnClass(java.lang.String[].class);
        oper.setReturnQName(new javax.xml.namespace.QName("", "getAvailableBackbonesReturn"));
        ...
        oper = new org.apache.axis.description.OperationDesc();
        oper.setName("getHID");
        oper.setReturnType(new javax.xml.namespace.QName("http://network.linksmart.eu", "HID"));
        oper.setReturnClass(eu.linksmart.network.HID.class);
        oper.setReturnQName(new javax.xml.namespace.QName("", "getHIDReturn"));
        oper.setStyle(org.apache.axis.constants.Style.RPC);
        oper.setUse(org.apache.axis.constants.Use.LITERAL);
        _operations[2] = oper;
        ...
        param = new org.apache.axis.description.ParameterDesc(new javax.xml.namespace.QName("", "in0"), org.apache.axis.description.ParameterDesc.IN, new javax.xml.namespace.QName("http://utils.linksmart.eu", "Parts"), eu.linksmart.utils.Part[].class, false, false);
        param.setItemQName(new javax.xml.namespace.QName("", "item"));
        oper.addParameter(param);
        ...
        oper.setReturnQName(new javax.xml.namespace.QName("", "removeHIDReturn"));
        oper.setStyle(org.apache.axis.constants.Style.RPC);
        oper.setUse(org.apache.axis.constants.Use.LITERAL);
        _operations[4] = oper;
        ...
        oper.addParameter(param);
        oper.setReturnType(new javax.xml.namespace.QName("http://network.linksmart.eu", "HIDInfo"));
        oper.setReturnClass(eu.linksmart.network.HIDInfo.class);
    ...
    public NetworkManagerSoapBindingStub(javax.xml.rpc.Service service) throws org.apache.axis.AxisFault {
        ...
        ((org.apache.axis.client.Service)super.service).setTypeMappingVersion("1.2");
            ...
            qName = new javax.xml.namespace.QName("http://network.linksmart.eu", "HID");
            cachedSerQNames.add(qName);
            cls = eu.linksmart.network.HID.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(beansf);
            cachedDeserFactories.add(beandf);

            qName = new javax.xml.namespace.QName("http://network.linksmart.eu", "HIDInfo");
            cachedSerQNames.add(qName);
            cls = eu.linksmart.network.HIDInfo.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(beansf);
            cachedDeserFactories.add(beandf);
            ...
            qName = new javax.xml.namespace.QName("http://networkmanager.network.linksmart.eu", "ArrayOf_xsd_string");
            cachedSerQNames.add(qName);
            ...
            qName = new javax.xml.namespace.QName("http://utils.linksmart.eu", "Parts");
            cachedSerQNames.add(qName);
            cls = eu.linksmart.utils.Part[].class;
            cachedSerClasses.add(cls);
            qName = new javax.xml.namespace.QName("http://utils.linksmart.eu", "Part");
 ...
 try {        java.lang.Object _resp = _call.invoke(new java.lang.Object[] {});
  ...
  throw axisFaultException;
    ...
    public eu.linksmart.network.HID getHID() throws java.rmi.RemoteException {
        ...
        _call.setProperty(org.apache.axis.AxisEngine.PROP_DOMULTIREFS, Boolean.FALSE);
        _call.setSOAPVersion(org.apache.axis.soap.SOAPConstants.SOAP11_CONSTANTS);
        _call.setOperationName(new javax.xml.namespace.QName("http://networkmanager.network.linksmart.eu", "getHID"));
 ...
 try {        java.lang.Object _resp = _call.invoke(new java.lang.Object[] {});
        ...
        if (_resp instanceof java.rmi.RemoteException) {
            ...
            extractAttachments(_call);
            try {
                return (eu.linksmart.network.HID) _resp;
            } catch (java.lang.Exception _exception) {
                return (eu.linksmart.network.HID) org.apache.axis.utils.JavaUtils.convert(_resp, eu.linksmart.network.HID.class);
            }
        }
  } catch (org.apache.axis.AxisFault axisFaultException) {
  throw axisFaultException;
    ...
    public eu.linksmart.network.HID createHID(eu.linksmart.utils.Part[] in0, java.lang.String in1, java.lang.String in2) throws java.rmi.RemoteException {
        ...
        _call.setProperty(org.apache.axis.AxisEngine.PROP_DOMULTIREFS, Boolean.FALSE);
        _call.setSOAPVersion(org.apache.axis.soap.SOAPConstants.SOAP11_CONSTANTS);
        _call.setOperationName(new javax.xml.namespace.QName("http://networkmanager.network.linksmart.eu", "createHID"));
 ...
 try {        java.lang.Object _resp = _call.invoke(new java.lang.Object[] {in0, in1, in2});
  ...
  throw axisFaultException;
    ...
    public boolean removeHID(eu.linksmart.network.HID in0) throws java.rmi.RemoteException {
        ...
        _call.setProperty(org.apache.axis.AxisEngine.PROP_DOMULTIREFS, Boolean.FALSE);
        _call.setSOAPVersion(org.apache.axis.soap.SOAPConstants.SOAP11_CONSTANTS);
        _call.setOperationName(new javax.xml.namespace.QName("http://networkmanager.network.linksmart.eu", "removeHID"));
 ...
 try {        java.lang.Object _resp = _call.invoke(new java.lang.Object[] {in0});
  ...
  throw axisFaultException;
    ...
    public eu.linksmart.network.HIDInfo createCryptoHID(java.lang.String in0) throws java.rmi.RemoteException {
        ...
        _call.setProperty(org.apache.axis.AxisEngine.PROP_DOMULTIREFS, Boolean.FALSE);
        _call.setSOAPVersion(org.apache.axis.soap.SOAPConstants.SOAP11_CONSTANTS);
        _call.setOperationName(new javax.xml.namespace.QName("http://networkmanager.network.linksmart.eu", "createCryptoHID"));
 ...
 try {        java.lang.Object _resp = _call.invoke(new java.lang.Object[] {in0});
        ...
        if (_resp instanceof java.rmi.RemoteException) {
            ...
            extractAttachments(_call);
            try {
                return (eu.linksmart.network.HIDInfo) _resp;
            } catch (java.lang.Exception _exception) {
                return (eu.linksmart.network.HIDInfo) org.apache.axis.utils.JavaUtils.convert(_resp, eu.linksmart.network.HIDInfo.class);
            }
        }
  } catch (org.apache.axis.AxisFault axisFaultException) {
  throw axisFaultException;
    ...
    public eu.linksmart.network.HIDInfo createCryptoHIDFromReference(java.lang.String in0) throws java.rmi.RemoteException {
        ...
        _call.setProperty(org.apache.axis.AxisEngine.PROP_DOMULTIREFS, Boolean.FALSE);
        _call.setSOAPVersion(org.apache.axis.soap.SOAPConstants.SOAP11_CONSTANTS);
        _call.setOperationName(new javax.xml.namespace.QName("http://networkmanager.network.linksmart.eu", "createCryptoHIDFromReference"));
