...
public class NMResponse  implements java.io.Serializable {
    ...
    private eu.linksmart.network.client.Message messageObject;
    ...
    public NMResponse(
           ...
           eu.linksmart.network.client.Message messageObject,
     ...
     */
    public eu.linksmart.network.client.Message getMessageObject() {
        return messageObject;
    }
     ...
     * @param messageObject
     */
    public void setMessageObject(eu.linksmart.network.client.Message messageObject) {
        this.messageObject = messageObject;
    }
