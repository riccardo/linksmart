...
public class Member_Helper {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://specification.cm.caf.linksmart.eu", "Member"));
        ...
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("instanceOf");
        elemField.setXmlName(new javax.xml.namespace.QName("", "instanceOf"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "string"));
        elemField.setNillable(true);
        typeDesc.addFieldDesc(elemField);
    }
