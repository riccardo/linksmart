...
package eu.linksmart.caf.cm.client.query;

import eu.linksmart.caf.cm.query.QuerySet;

public class QuerySet_Helper {
    // Type metadata
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(QuerySet.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://query.cm.caf.linksmart.eu", "QuerySet"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("http://query.cm.caf.linksmart.eu", "ContextQuery"));
        elemField.setNillable(true);
        elemField.setItemQName(new javax.xml.namespace.QName("", "item"));
        typeDesc.addFieldDesc(elemField);
    }
