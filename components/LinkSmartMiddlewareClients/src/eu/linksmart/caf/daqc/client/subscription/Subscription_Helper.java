...
public class Subscription_Helper {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://subscription.daqc.caf.linksmart.eu", "Subscription"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("http://caf.linksmart.eu", "Parameter"));
        elemField.setNillable(true);
        elemField.setItemQName(new javax.xml.namespace.QName("", "item"));
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
