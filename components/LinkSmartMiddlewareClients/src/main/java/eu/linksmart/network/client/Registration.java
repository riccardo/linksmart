...
public class Registration  implements java.io.Serializable {
    ...
    private eu.linksmart.network.client.VirtualAddress virtualAddress;
    ...
    public Registration(
           ...
           eu.linksmart.network.client.VirtualAddress virtualAddress,
     ...
     */
    public eu.linksmart.network.client.VirtualAddress getVirtualAddress() {
        return virtualAddress;
    }
     ...
     */
    public void setVirtualAddress(eu.linksmart.network.client.VirtualAddress virtualAddress) {
        this.virtualAddress = virtualAddress;
    }
