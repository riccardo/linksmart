...
public class HIDInfo {
	 ...
	 * @param jxtaID the JXTA ID
	 */
	public HIDInfo(String ip, int port, String description, String endpoint,
			PeerID jxtaID) {
	 ...
	 */
	public HIDInfo(String ip, int port, String description, String endpoint,
			PeerID jxtaID, Properties attributes) {
	...
	public String toString() {
		return ip + ":" + port  + ":" + description + ":" + endpoint + ":" + id.toString();
	}
