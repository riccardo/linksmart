...
/**
 * Represents the state when an acknowledgment has been received
 * from the client side. No commands are handled in this state.
 * @author Mark Vinkovits - mark.vinkovits@fit.fraunhofer.de
 *
 */
public class AcknowledgedState implements ProtocolState {

	/**
	 * Informs the context that protocol run is finished.
	 * @param context
	 */
	public AcknowledgedState(ProtocolContext context){
		context.finished();
	}
