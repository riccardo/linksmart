...
/**
 * Represents the state when something went wrong and protocol
 * has to be aborted.
 * @author Mark Vinkovits - mark.vinkovits@fit.fraunhofer.de
 *
 */
public class FailedState implements ProtocolState {

	/**
	 * Informs the context to abort protocol.
	 * @param context
	 */
	public FailedState(ProtocolContext context){
		context.quit();
	}
