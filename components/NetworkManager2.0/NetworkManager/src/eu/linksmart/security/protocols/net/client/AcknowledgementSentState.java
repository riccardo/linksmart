...
/**
 * When entering the state acknowledgment is sent and protocol is marked as finished
 */
public class AcknowledgementSentState implements ProtocolState {

	public AcknowledgementSentState(ProtocolContext context){
		context.sendAck();
		context.finished();
	}
