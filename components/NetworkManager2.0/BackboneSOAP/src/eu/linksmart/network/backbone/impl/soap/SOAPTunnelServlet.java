...
public class SOAPTunnelServlet extends HttpServlet {
	...
	private Backbone backboneSoapTunnel;
	 ...
	 * 
	 */
	public SOAPTunnelServlet(Backbone bm) {
		this.backboneSoapTunnel = bm;
	}
	...
	public void doGet(HttpServletRequest request, HttpServletResponse response) 
		...
		NMResponse r = backboneSoapTunnel.sendData(sHid, rHid, req.getBytes());
		...
		if (token.countTokens() > 2) {
			...
			if((request.getContentLength() > 0)) {
				try {
					...
					NMResponse r = backboneSoapTunnel.sendData(senderHID, receiverHID, SOAPRequest.getBytes());
					sResp = r.getData();
