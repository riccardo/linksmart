...
public class TrustManagerIT {
    ...
    public Option[] config() {
        return new Option[] {
        		...
        		features(ITConfiguration.getFeaturesRepositoryURL(),"trust-manager"),  // this feature will install all bundles including required dependencies without web-service provider                  
        };
    }
