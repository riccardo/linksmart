...
public class BackboneRouterImplDummy implements BackboneRouter {
    ...
    protected void bindConfigAdmin(ConfigurationAdmin configAdmin) {
    	System.out.println("BackboneRouterDummy::binding configadmin");
        this.mConfigAdmin = configAdmin;
    }

    protected void unbindConfigAdmin(ConfigurationAdmin configAdmin) {
    	System.out.println("BackboneRouterDummy::un-binding configadmin");
        this.mConfigAdmin = null;
    }

    protected void bindBackbone(Backbone backbone) {
    	System.out.println("BackboneRouterDummy::binding backbone");
        mBackbone = backbone;
        if (!(availableBackbones.containsValue(backbone))) {
        	availableBackbones.put(backbone.getClass().getName(), backbone);
            System.out.println("Added backbone to router: " + backbone.getName());
        } 
    }
    
    protected void unbindBackbone(Backbone backbone) {
    	System.out.println("BackboneRouterDummy::un-binding backbone");
        mBackbone = backbone;
        availableBackbones.values().remove(backbone);
    }
    
    protected void bindNMCore(NetworkManagerCore core) {
    	System.out.println("BackboneRouterDummy::binding networkmanager-core");
        nmCore = core;
    }

    protected void unbindNMCore(NetworkManagerCore core) {
    	System.out.println("BackboneRouterDummy::un-binding networkmanager-core");
        nmCore = null;
    }

    @Activate
    protected void activate(ComponentContext context) {
        System.out.println("[activating BackboneRouterDummy]");
    ...
    protected void deactivate(ComponentContext context) {
    	System.out.println("de-activating BackboneRouterDummy");
    }
