...
public class DeviceSchema extends Schema{

	private static DeviceSchema instance;
	
	//private int symname,id,location;
	public static DeviceSchema instance(){
		if (instance==null)
			instance=new DeviceSchema();
		return instance;
	}
	...
	Tuple newTuple(String id){
		Tuple t = newTuple();
		try {
			t.setValue(deviceid, id);
