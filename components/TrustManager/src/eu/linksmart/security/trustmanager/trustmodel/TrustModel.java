...
public interface TrustModel {
	...
	/**
	 * Get the trust value for a given token
	 * 
	 * @param token
	...
	/**
	 * Get the identifier of the trust model that implements this interface
	 * 
	 * @return Identifier of this trust model
	 */
	String getIdentifier();

	/**
	 * Initialize this trust model
	 */
	void initialize();
