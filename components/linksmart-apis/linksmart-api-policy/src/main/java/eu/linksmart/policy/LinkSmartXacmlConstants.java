 ...
 *
 */
public enum LinkSmartXacmlConstants {
	...
	/** LinkSmart connection attribute category */
	CONNECTION_PROPERTY_CATEGORY("linksmart:policy:attribute-category:connection"),
	
	/** Applied security of connection */
	CONNECTION_PROPERTY_APPLIED("linksmart:policy:connection:applied");
	 ...
	 * 				the urn
	 */
	private LinkSmartXacmlConstants(String theUrn) {
		urn = theUrn;
	}
