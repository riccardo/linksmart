...
import eu.linksmart.policy.pep.response.bundle.impl.EventPepObligationObserverConfigurator;
import eu.linksmart.policy.pep.response.bundle.impl.EventPepObligationObserverWrapper;

/**
 * Unit test for {@link EventPepObligationObserverConfigurator}
 * 
 * @author Marco Tiemann
 *
 */
public class JunitEventPepObligationObserverConfiguratorTest extends TestCase {

	@SuppressWarnings({"unchecked" })
	@Test
	public void testApplyConfigurations() {
		EventPepObligationObserverConfigurator observer = null;
		try {
		...
		if (observer == null) {
			fail("Observer is null");
		}
		// empty configuration
		observer.applyConfigurations(new Hashtable());
		// some configuration options
		Hashtable configuration = new Hashtable();
		configuration.put(EventPepObligationObserverConfigurator.CONFIG_EM_PID, 
				"EM:pty");
		observer.applyConfigurations(configuration);
	}

	@Test
	public void testEventPepObligationObserverConfigurator() {
		assertNotNull(getInstance());
	}
	
	/**
	 * @return
	 * 				an {@link EventPepObligationObserverConfigurator}
	 */
	@SuppressWarnings("unchecked")
	private EventPepObligationObserverConfigurator getInstance() {
		...
		EventPepObligationObserverWrapper observer
				= new EventPepObligationObserverWrapper();
		try {
			EventPepObligationObserverConfigurator configurator 
				= new EventPepObligationObserverConfigurator(bundleCtxMock, 
						observer);
			verify(confMock);
