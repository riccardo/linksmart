...
/**
 * This interface defines methods to be used by core security.
 * 
...
public interface SecurityLibrary {
	...
	public static final String CORE_MAC_MESSAGE_NAMESPACE = "http://linksmart.eu/ns/security/core_mac";
	public static final String CORE_PROTECTED_MESSAGE_NAME = "linksmart:CoreProtectedMessage";
	public static final String CORE_MAC_MESSAGE_NAME = "linksmart:CoreMacProtectedMessage";
	 ...
	 * Core-message in XML format. If the core SEC key cannot be found in
	 ...
	 * 
	 * @param plaintextData
	 * @return a XML formatted Core Sec message
	 * @throws CryptoException
	 */
	public String protectCoreMessage(String plaintextData) throws CryptoException;

	/**
	 * Configures the protection level that applies to Core security.
	 * <p>
	...
	/**
	 * Gets a self-contained protected Core Sec message (as generated by
	 ...
	 * a respective VerificationFailureException will be thrown. 
	 * Further, if the keystore is not accessible or any other error occurred 
	 * during the operation, an Exception will be thrown. This method never returns null.
	 * 
	 * @param protectedData
	 *            a XMl formatted Core Sec message.
	 * @return plain content of the Core Sec message.
	...
	/**
	 * Checks if <code>message</code> is a valid Core Sec message.
	 * <p>
	 ...
	 * 
	 * @param Cookie received with message
	 * @return false If cookie should not be accepted
	 */
	public boolean checkCookie(String cookie);
	
	/**
	 * Provides cookie which should be put into a message
	 * @return The actual cookie value
	 */
