...
public class EventManagerImplementationLocator extends org.apache.axis.client.Service implements eu.linksmart.eventmanager.EventManagerImplementation {

    public EventManagerImplementationLocator() {
    }


    public EventManagerImplementationLocator(org.apache.axis.EngineConfiguration config) {
        super(config);
    }

    public EventManagerImplementationLocator(java.lang.String wsdlLoc, javax.xml.namespace.QName sName) throws javax.xml.rpc.ServiceException {
        super(wsdlLoc, sName);
    }

    // Use to get a proxy class for BasicHttpBinding_EventManagerPort
    private java.lang.String BasicHttpBinding_EventManagerPort_address = "http://192.168.199.1:8124/Service";
    ...
    public eu.linksmart.eventmanager.EventManagerPort getBasicHttpBinding_EventManagerPort(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            eu.linksmart.eventmanager.BasicHttpBinding_EventManagerPortStub _stub = new eu.linksmart.eventmanager.BasicHttpBinding_EventManagerPortStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (eu.linksmart.eventmanager.EventManagerPort.class.isAssignableFrom(serviceEndpointInterface)) {
                eu.linksmart.eventmanager.BasicHttpBinding_EventManagerPortStub _stub = new eu.linksmart.eventmanager.BasicHttpBinding_EventManagerPortStub(new java.net.URL(BasicHttpBinding_EventManagerPort_address), this);
                _stub.setPortName(getBasicHttpBinding_EventManagerPortWSDDServiceName());
                return _stub;
            }
        }
