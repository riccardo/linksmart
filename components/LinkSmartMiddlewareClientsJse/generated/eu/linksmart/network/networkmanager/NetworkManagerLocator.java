...
public class NetworkManagerLocator extends org.apache.axis.client.Service implements eu.linksmart.network.networkmanager.NetworkManager {
    ...
    public eu.linksmart.network.networkmanager.NetworkManagerPortType getNetworkManagerPort() throws javax.xml.rpc.ServiceException {
    ...
    public eu.linksmart.network.networkmanager.NetworkManagerPortType getNetworkManagerPort(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            eu.linksmart.network.networkmanager.NetworkManagerSoapBindingStub _stub = new eu.linksmart.network.networkmanager.NetworkManagerSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (eu.linksmart.network.networkmanager.NetworkManagerPortType.class.isAssignableFrom(serviceEndpointInterface)) {
                eu.linksmart.network.networkmanager.NetworkManagerSoapBindingStub _stub = new eu.linksmart.network.networkmanager.NetworkManagerSoapBindingStub(new java.net.URL(NetworkManagerPort_address), this);
                _stub.setPortName(getNetworkManagerPortWSDDServiceName());
                return _stub;
            }
        }
