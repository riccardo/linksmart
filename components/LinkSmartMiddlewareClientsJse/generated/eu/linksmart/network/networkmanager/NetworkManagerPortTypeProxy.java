...
public class NetworkManagerPortTypeProxy implements eu.linksmart.network.networkmanager.NetworkManagerPortType {
  private String _endpoint = null;
  private eu.linksmart.network.networkmanager.NetworkManagerPortType networkManagerPortType = null;
  ...
  private void _initNetworkManagerPortTypeProxy() {
    try {
      networkManagerPortType = (new eu.linksmart.network.networkmanager.NetworkManagerLocator()).getNetworkManagerPort();
  ...
  public eu.linksmart.network.networkmanager.NetworkManagerPortType getNetworkManagerPortType() {
    if (networkManagerPortType == null)
      _initNetworkManagerPortTypeProxy();
