...
public class VirtualAddress  implements java.io.Serializable {
    ...
    public synchronized int hashCode() {
        ...
        if (getContextID1() != null) {
            _hashCode += getContextID1().hashCode();
        }
        if (getContextID2() != null) {
            _hashCode += getContextID2().hashCode();
        }
        if (getContextID3() != null) {
            _hashCode += getContextID3().hashCode();
        }
        if (getDeviceID() != null) {
