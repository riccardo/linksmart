 ...
 */
package eu.linksmart.limbo.frontend.energy;
...
public class EnergyServiceFrontend implements Frontend {

	
	private static Logger log = Logger.getLogger(EnergyServiceFrontend.class.getName());
	...
	public void process() {
		...
		try {
			...
			log.log(Level.SEVERE, "EnergyService frontend error getting wsdl from Repository!");
			e.printStackTrace();
		}
		if(!definition.equals(null)) {
			try {
			    ...
			    this.copyFileFromInputStream(EnergyServiceFrontend.class.getResourceAsStream("/resources/energy.wsdl"), new File("resources/energy.wsdl"));
				linksmartStandardDefinition = reader.readWSDL(null,new File("resources/energy.wsdl").getAbsolutePath());
