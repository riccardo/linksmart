 ...
 */
package eu.linksmart.limbo.backend.energy;
...
public class EnergyServiceBackend implements Backend {

	
	private static Logger log = Logger.getLogger(EnergyServiceBackend.class.getName());
