...
public class Message  implements java.io.Serializable {
    ...
    private eu.linksmart.network.VirtualAddress receiverVirtualAddress;

    private eu.linksmart.network.VirtualAddress senderVirtualAddress;
    ...
    public Message(
           ...
           eu.linksmart.network.VirtualAddress receiverVirtualAddress,
           eu.linksmart.network.VirtualAddress senderVirtualAddress,
     ...
     */
    public eu.linksmart.network.VirtualAddress getReceiverVirtualAddress() {
        return receiverVirtualAddress;
    }
     ...
     */
    public void setReceiverVirtualAddress(eu.linksmart.network.VirtualAddress receiverVirtualAddress) {
        this.receiverVirtualAddress = receiverVirtualAddress;
    }
     ...
     */
    public eu.linksmart.network.VirtualAddress getSenderVirtualAddress() {
        return senderVirtualAddress;
    }
     ...
     */
    public void setSenderVirtualAddress(eu.linksmart.network.VirtualAddress senderVirtualAddress) {
        this.senderVirtualAddress = senderVirtualAddress;
    }
    ...
    public synchronized int hashCode() {
        ...
        if (getKeySet() != null) {
            for (int i=0;
                 i<java.lang.reflect.Array.getLength(getKeySet());
                 i++) {
                java.lang.Object obj = java.lang.reflect.Array.get(getKeySet(), i);
                if (obj != null &&
                    !obj.getClass().isArray()) {
                    _hashCode += obj.hashCode();
                }
        ...
        if (getReceiverVirtualAddress() != null) {
            _hashCode += getReceiverVirtualAddress().hashCode();
        }
        if (getSenderVirtualAddress() != null) {
            _hashCode += getSenderVirtualAddress().hashCode();
        }
        if (getTopic() != null) {
